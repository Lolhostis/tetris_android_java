package fr.iut.dut2.tetris.application.src.classes.content.pieces.tourneur;
...
public class TourneurBase {
     ...
     */
    public void tournerGauche(PointBase[] points, @NotNull PieceType type, EtatRotation rotation) {
        switch (type) {
     ...
     * @param rotation état de la rotation de la pièce
     */
    public void tournerDroite(PointBase[] points, @NotNull PieceType type, EtatRotation rotation) {
        switch (type) {
